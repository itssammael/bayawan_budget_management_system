...
onMounted(() => {
    ...
    // Colors match the MOOE chart for consistency
    createSeries("PROJECT COST", "cost", 0x93C5FD, 100); // Light Blue (Back)
    createSeries("ACTUAL EXPENDITURES", "expenditures", 0x3B82F6, 60); // Blue (Middle)
...
<template>
    <div class="bg-white p-4 shadow rounded-lg border border-gray-200">
        <h4 class="text-sm font-semibold text-gray-700 mb-2 uppercase text-center">CAPITAL OUTLAY</h4>
